...
export class FuturePrediction implements OnInit {
  ...
  ngOnInit() {
    ...
    createForm() {
      this.angForm = this.fb.group({
        ...
        DistToTown: ['', Validators.required ],
        Populationindex: ['', Validators.required ],
        Bank: ['', Validators.required ],
        ZipCode: ['', Validators.required ],
        IsFloodedArea: ['', Validators.required ],
    ...
    //addLandInfo(HospitalDistance,  SchoolDistance,DistToTown,Populationindex, Bank, ZipCodet, address, lat, lon) {
    //const id = this.userId.id;
    //console.log(id);
      //this.addLandService.addLand(HospitalDistance,SchoolDistance,DistToTown,Populationindex, Bank, ZipCodet, address, lat, lon);
